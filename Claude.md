...
### 项目描述
苏格拉底 Skill，是一个富有哲学意味的 Skill，它不是为了解决某个特定问题，而是为了辅助思考。

采用 苏格拉底诘问法 + 第一性原理 + 奥卡姆剃刀 的方法进行思考，指导 LLM 进行真正的深入思考，无限的自我反问与迭代。
...
- 技能使用：**使用 `skill-creator` `superpowers:writing-skills` 等相关skill来开发符合统一标准的Skill。**
